...
@section('indicator-detail-create')

<div class="margin-judul">
  <h1>Buat Detail Indikator</h1>
  <ol class="breadcrumb" style="background: none; padding: 10px 0px;">
    <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
    <li class="active">Buat Detail Indikator</li>
  </ol>
</div>
          ...
          <form action="{{route('produsenDataIndicatorDetailSave')}}" method="POST">
            ...
            <form action="{{route('verifikatorIndicatorDetailSave')}}" method="POST">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="indikator_id" name="indikator_id">
                    ...
                    <option value="{{ $datas->id }}" @if(old("indikator_id")==$datas->id) selected @endif > {{ $datas->name }} </option>
                    @endforeach
                  </select>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="nilai" name="nilai" value="{{old("nilai")}}" placeholder="Nilai">
                  @if($errors->has('nilai'))
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="satuan" name="satuan" value="{{old("satuan")}}" placeholder="Satuan">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="tahun" name="tahun" value="{{old("tahun")}}" placeholder="Tahun">
                  @if($errors->has('tahun'))
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="target" name="target" value="{{old("target")}}" placeholder="Target">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="capaian" name="capaian" value="{{old("capaian")}}" placeholder="Capaian">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="validasi" name="validasi">
                    ...
                    <option value="1" @if(old("validasi")=='1' )selected @endif>Tervalidasi</option>
                    <option value="0" @if(old("validasi")=='0' )selected @endif>Belum Divalidasi</option>
                  </select>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="verifikasi" name="verifikasi">
                    ...
                    <option value="1" @if(old("verifikasi")=='1' )selected @endif>Terverifikasi</option>
                    <option value="0" @if(old("verifikasi")=='0' )selected @endif>Belum Diverifikasi</option>
                  </select>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="publish" name="publish" value="{{old("publish")}}" placeholder="Publish">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="catatan" name="catatan" value="{{old("catatan")}}" placeholder="Catatan">
