                                ...
                                <div class="header-right-info">
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        <li class="nav-item">
                                            ...
                                            <a class="fa fa-bell" href="{{ route('verifikatorIndicatorList') }}" >{{ $notif ?? ''}}</a>
                                            @elseif($user->isValidator())
                                            <a class="fa fa-bell" href="{{ route('validatorIndicatorList') }}" >{{ $notif ?? '' }}</a>
                                            @elseif($user->isAdministrator())
                                            <a class="fa fa-bell" href="{{ route('adminUserValidationList') }}" >{{ $notif ?? '' }}</a>
                                            @endif
